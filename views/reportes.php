...
<body class="fixed-navbar">
                    ...
                    <div class="card container">
                        <div class="col-xl-12">
                                ...
                                <div class="ibox-body" id='bodyP'>
                                    <form class="form-inline" id='formReporte'>
                                        <div class="input-daterange input-group col" id="datepicker">
                                            ...
                                            <div class="ml-4 col">
                                                <select class="form-control" id="sectorSelect" style="width: 100%" data-hide-search="true">
                            ...
                            <div class="ibox" id="resultTable">
                                <div class="ibox-body">
                                    <div class="row">
                                        <h2 class="col" id='sectorReport'>Sector: "Nombre"</h2>
  ...
  <script src="../js/console-reportes.js" type="text/javascript"></script>
</body>
</html>